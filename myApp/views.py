...
CLIENT_ID = '844ca1950502669'

CLIENT_SECRET = '04f11ca886c2d66bae2e598b6b26cd29f0e11b1d'

PARALLEL_DOTS_KEY = "PYKaign7QyhoblmhSURvfG6JrpKSxlimHoOK38j0Xqg"
...
def checkImage(path):
    app = ClarifaiApp(api_key='acc56bad5e43486092e9182e6bf424ee')
    flag = False
